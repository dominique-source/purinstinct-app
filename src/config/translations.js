export const T={
  fr:{
    ...
    nfcUnassignedDesc:"Ce bracelet n'est associé à aucun profil actif. Demandez à un responsable de l'assigner.",
  ...
  en:{
    ...
    nfcUnassignedDesc:"This wristband isn't linked to an active profile. Ask a staff member to assign it.",
