export const T={
  fr:{
    ...
    stationQrDesc:"À imprimer et coller sur chaque poste — un scan met le téléphone en mode responsable de plateau pour cette zone, sans code PIN.",
  ...
  en:{
    ...
    stationQrDesc:"Print and post at each station — scanning puts the phone into station-manager mode for that zone, no PIN needed.",
